...
static void do_find (Unit *unit, dpacket packet, int mode, int create, int fallback)
{
   ...
   //write_log ("volflags:%d, MYVOLUMEINFO_ARCHIVE:%d\n", unit->volflags, MYVOLUMEINFO_ARCHIVE);
...
//Cambio attributi quando creo il file in ogni caso 
  
  //write_log ("create:%d, isarch:%d\n", create, isarch);
