...
void SEND_GUI_Operation(const char *message)
{
	
			Draw_text((char*)Retro_Screen,20 , 20 ,RGB565(7, 7, 7), RGB565(29, 29, 29) ,1, 1,10,"Switch to:");
            if (currprefs.gfx_size.width > 320)
                Draw_text((char*)Retro_Screen,20 , 30 ,RGB565(7, 7, 7), RGB565(29, 29, 29) ,1, 1,100,message);
            else
            {
                Draw_text((char*)Retro_Screen,20 , 30 ,RGB565(7, 7, 7), RGB565(29, 29, 29) ,1, 1,40,message);
                if (strlen (message) > 40)
                    Draw_text((char*)Retro_Screen,20 , 40 ,RGB565(7, 7, 7), RGB565(29, 29, 29) ,1, 1,40,message );
            }
