...
{
  //write_log ("Starting check_prefs_changed_gfx");
  int changed = 0;
	 ...
	 currprefs.ntscmode != changed_prefs.ntscmode)
  {
    ...
    currprefs.gfx_resolution = changed_prefs.gfx_resolution;
	currprefs.ntscmode = changed_prefs.ntscmode;
    //write_log ("check_prefs_changed_gfx update_display. \n");
  ...
  if (currprefs.chipset_refreshrate != changed_prefs.chipset_refreshrate) 
  {
  	currprefs.chipset_refreshrate = changed_prefs.chipset_refreshrate;
	    //write_log ("check_prefs_changed_gfx init_hz. \n");
  ...
  if(changed)
  {	 
	//write_log ("check_prefs_changed_gfx init_custom. \n");	
	init_custom ();
	}
	 //write_log ("Fineshed check_prefs_changed_gfx. \n");	
  return changed;
